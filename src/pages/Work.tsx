                  ...
                  <HoverCardTrigger asChild>
                    ...
                    >
                      ...
                      <img
                        ...
                        alt="Video thumbnail"
                        className={`w-full h-full object-cover rounded-xl transition-opacity duration-200 ${item.thumbnail ? 'object-[center_30%]' : ''} ${hoveredVideo === item.id ? 'opacity-0' : 'opacity-100'}`}
                      />
